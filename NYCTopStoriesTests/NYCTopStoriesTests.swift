...
import XCTest
@testable import NYCTopStories

class NYCTopStoriesTests: XCTestCase {
    
    // unit test for out TopStory model
...
""".data(using: .utf8)!
        //MARK: we are checking if our model works 
